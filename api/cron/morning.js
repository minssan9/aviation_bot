/**
 * Vercel Cron Function - Morning Notification (9 AM KST)
 *
 * This function sends morning aviation knowledge messages to all subscribers.
 * Triggered by Vercel Cron at 9:00 AM KST (0:00 UTC)
 */
...
module.exports = async (req, res) => {
  try {
    ...
    const message = await messageGenerator.generateMessage('morning');
    ...
    console.log(`✅ Morning notifications sent: ${successful} successful, ${failed} failed`);
