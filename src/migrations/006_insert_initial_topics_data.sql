-- 기본 토픽 데이터 삽입
INSERT INTO topics (name, description, day_of_week) VALUES
('응급상황 및 안전', '항공기 운항 중 발생할 수 있는 응급상황과 안전 절차에 대한 지식', 0),
('항공역학', '항공기 비행 원리와 공기역학적 특성에 대한 기본 이론', 1),
('항법', '항공기 항법 시스템과 비행 경로 계획에 관한 지식', 2),
('기상학', '항공 기상과 날씨가 비행에 미치는 영향', 3),
('항공기 시스템', '항공기의 각종 시스템과 작동 원리', 4),
('비행 규정', '항공 법규와 운항 절차에 관한 규정', 5),
('비행 계획 및 성능', '항공기 성능 계산과 비행 계획 수립', 6)
