...
const TopicService = require('../aviation-quiz-system/aviation-knowledge/topicService');
const { AviationKnowledgeService, AviationKnowledgeManager } = require('../aviation-quiz-system/aviation-knowledge/aviationKnowledgeService');
