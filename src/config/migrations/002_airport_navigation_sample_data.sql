...
-- ----------------------------------------------------------------------------
INSERT INTO terminals (id, name_ko, name_en, airport_code) VALUES
...
-- Insert Floor Data
-- ----------------------------------------------------------------------------
INSERT INTO floors (id, terminal_id, floor_number, map_image_path) VALUES
...
-- Entrance waypoints
INSERT INTO waypoints (id, terminal_id, floor_number, type, name_ko, name_en, map_x, map_y, gps_lat, gps_lon, is_accessible) VALUES
...
INSERT INTO waypoints (id, terminal_id, floor_number, type, name_ko, name_en, map_x, map_y, metadata, is_accessible) VALUES
...
INSERT INTO waypoints (id, terminal_id, floor_number, type, name_ko, name_en, map_x, map_y, is_accessible) VALUES
...
INSERT INTO waypoint_connections (from_waypoint_id, to_waypoint_id, distance_meters, walking_time_seconds, connection_type) VALUES
...
INSERT INTO waypoint_connections (from_waypoint_id, to_waypoint_id, distance_meters, walking_time_seconds, connection_type)
...
-- Korean Air flights
('KE001', 'KE', '대한항공', 'Korean Air', DATE_ADD(NOW(), INTERVAL 4 HOUR), 'JFK', '뉴욕 (존 F. 케네디)', 'New York (JFK)', 'T1', 'A', '01-20', '101', 'T1-3F-GATE-101', 'T1-3F-COUNTER-A', DATE_ADD(NOW(), INTERVAL 3 HOUR), DATE_ADD(NOW(), INTERVAL 3 HOUR 40 MINUTE), 'SCHEDULED'),
('KE123', 'KE', '대한항공', 'Korean Air', DATE_ADD(NOW(), INTERVAL 6 HOUR), 'LAX', '로스앤젤레스', 'Los Angeles', 'T1', 'A', '01-20', '102', 'T1-3F-GATE-102', 'T1-3F-COUNTER-A', DATE_ADD(NOW(), INTERVAL 5 HOUR), DATE_ADD(NOW(), INTERVAL 5 HOUR 40 MINUTE), 'SCHEDULED'),
('KE456', 'KE', '대한항공', 'Korean Air', DATE_ADD(NOW(), INTERVAL 8 HOUR), 'LHR', '런던 (히드로)', 'London (Heathrow)', 'T1', 'A', '01-20', '103', 'T1-3F-GATE-103', 'T1-3F-COUNTER-A', DATE_ADD(NOW(), INTERVAL 7 HOUR), DATE_ADD(NOW(), INTERVAL 7 HOUR 40 MINUTE), 'SCHEDULED'),

-- Asiana Airlines flights
('OZ201', 'OZ', '아시아나항공', 'Asiana Airlines', DATE_ADD(NOW(), INTERVAL 5 HOUR), 'NRT', '도쿄 (나리타)', 'Tokyo (Narita)', 'T1', 'A', '01-20', '104', 'T1-3F-GATE-104', 'T1-3F-COUNTER-A', DATE_ADD(NOW(), INTERVAL 4 HOUR), DATE_ADD(NOW(), INTERVAL 4 HOUR 40 MINUTE), 'SCHEDULED'),
('OZ345', 'OZ', '아시아나항공', 'Asiana Airlines', DATE_ADD(NOW(), INTERVAL 7 HOUR), 'CDG', '파리 (샤를 드골)', 'Paris (CDG)', 'T1', 'A', '01-20', '105', 'T1-3F-GATE-105', 'T1-3F-COUNTER-A', DATE_ADD(NOW(), INTERVAL 6 HOUR), DATE_ADD(NOW(), INTERVAL 6 HOUR 40 MINUTE), 'SCHEDULED'),

-- Low-cost carriers
('7C801', '7C', '제주항공', 'Jeju Air', DATE_ADD(NOW(), INTERVAL 3 HOUR), 'BKK', '방콕 (수완나품)', 'Bangkok (Suvarnabhumi)', 'T1', 'B', '21-40', '201', 'T1-3F-GATE-201', 'T1-3F-COUNTER-B', DATE_ADD(NOW(), INTERVAL 2 HOUR), DATE_ADD(NOW(), INTERVAL 2 HOUR 40 MINUTE), 'SCHEDULED'),
('TW301', 'TW', '티웨이항공', 'T\'way Air', DATE_ADD(NOW(), INTERVAL 4 HOUR 30 MINUTE), 'CTS', '삿포로 (신치토세)', 'Sapporo (New Chitose)', 'T1', 'B', '21-40', '202', 'T1-3F-GATE-202', 'T1-3F-COUNTER-B', DATE_ADD(NOW(), INTERVAL 3 HOUR 30 MINUTE), DATE_ADD(NOW(), INTERVAL 4 HOUR 10 MINUTE), 'SCHEDULED'),
('LJ567', 'LJ', '진에어', 'Jin Air', DATE_ADD(NOW(), INTERVAL 5 HOUR 30 MINUTE), 'FUK', '후쿠오카', 'Fukuoka', 'T1', 'C', '41-60', '203', 'T1-3F-GATE-203', 'T1-3F-COUNTER-C', DATE_ADD(NOW(), INTERVAL 4 HOUR 30 MINUTE), DATE_ADD(NOW(), INTERVAL 5 HOUR 10 MINUTE), 'SCHEDULED');
