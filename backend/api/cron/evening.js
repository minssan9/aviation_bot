/**
 * Vercel Cron Function - Evening Notification (8 PM KST)
 *
 * This function sends evening aviation knowledge messages to all subscribers.
 * Triggered by Vercel Cron at 8:00 PM KST (11:00 UTC)
 */
...
module.exports = async (req, res) => {
  try {
    ...
    const message = await messageGenerator.generateMessage('evening');
    ...
    console.log(`✅ Evening notifications sent: ${successful} successful, ${failed} failed`);
